...
{{if ne .Size ""}}{{if and (ne .File.Size "") (ne .File.Size .Size)}}💾 {{.File.Size}} {{end}}📦 {{.Size}}{{end}}{{if gt .Seeders 0}} 👤 {{.Seeders}}{{end}}{{if ne .Group ""}} ⚙️ {{.Group}}{{end}}{{if ne .Site ""}} 🔗 {{.Site}}{{end}}{{if ne (len .Languages) 0}}
