...
generate "429" "Too Many Requests" --indicator "!!!|"
...
generate "payment_required" "Need Store Subscription Upgrade" --indicator "\$\$\$|"
generate "store_limit_exceeded" "Store Limit Exceeded" --indicator "!!!|"
